...
if lcd is not None:
    ...
    normal_jump_assets_ok = (
        ...
        and len(lcd_normal_animation_sprites) == 4
        and all(
...
# After a full idle minute it performs one four-frame jump, then waits another
...
NORMAL_ANIMATION_FRAME_DURATIONS_MS = (260, 220, 340, 260)
...
while True:
    ...
    time.sleep_ms(80 if normal_animator.active else 200)
